...
export const ALLOWED_JOB_TRANSITIONS: Record<JobStatus, JobStatus[]> = {
  REQUESTED: ["ACCEPTED", "SCHEDULED", "DIAGNOSING", "AWAITING_APPROVAL", "CANCELLED"],
  ACCEPTED: ["SCHEDULED", "DIAGNOSING", "AWAITING_APPROVAL", "IN_PROGRESS", "CANCELLED"],
  SCHEDULED: ["EN_ROUTE", "ARRIVED", "DIAGNOSING", "AWAITING_APPROVAL", "IN_PROGRESS", "CANCELLED"],
  EN_ROUTE: ["ARRIVED", "DIAGNOSING", "AWAITING_APPROVAL", "CANCELLED"],
  ARRIVED: ["DIAGNOSING", "AWAITING_APPROVAL", "IN_PROGRESS", "CANCELLED"],
  DIAGNOSING: ["AWAITING_APPROVAL", "IN_PROGRESS", "CANCELLED"],
  AWAITING_APPROVAL: ["IN_PROGRESS", "DIAGNOSING", "SCHEDULED", "CANCELLED", "DISPUTED"],
